...
namespace Core.CrossCuttingConcerns.Caching.Microsoft
{
    ...
    public class MemoryCacheManager : ICacheManager
    {
        ...
        {
            System.Reflection.PropertyInfo cacheEntriesCollectionDefinition = typeof(MemoryCache).
                GetProperty("EntriesCollection",
                System.Reflection.BindingFlags.NonPublic | System.Reflection.BindingFlags.Instance);
            dynamic cacheEntriesCollection =
            ...
            var keysToRemove =
                cacheCollectionValues.Where(d => regex.IsMatch(d.Key.ToString())).Select(d => d.Key).ToList();
